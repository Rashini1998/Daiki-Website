...
//   useEffect(() => {
//     setShowImage(false);
//     const timer = setTimeout(() => setShowImage(true), 50); // Delay to ensure state update is processed
...
//               src={service.imgSrc}
//               alt={service.title}
//               className={`img-fluid ${showImage ? 'show' : 'hide'}`}
//             />
//           </div>
//           {Array.isArray(service.description) ? (
//             <div className="service-description">
  ...
  return (
    <div className="container">
      {service.title ? (
        <TransitionGroup>
          <CSSTransition
            key={service.imgSrc}  // Key ensures proper transition
            timeout={1000}
            classNames="fade"
          >
            <div>
